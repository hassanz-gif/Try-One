...
setImmediate(()=>setImmediate(()=>{
  ...
  console.log('camera radius:', cr.toFixed(1), '(expect ~', (788-2.3).toFixed(1), ') z=', G.camera.position.z.toFixed(1));
  ok.cameraOnRing = Math.abs(cr-(788-2.3))<2;
  ...
  ok.staysOnFloor = Math.abs(cr2-(788-2.3))<2;
