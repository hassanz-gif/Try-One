...
(() => {
  ...
  function updateCharacter(dt) {
    ...
    // The model is YOU. Shown in both views: third person shows all of him; first
    // person hides his head (so it doesn't fill the camera) and you see your own
    // torso/legs/arms when you look down. Now correctly sized (~player height).
    playerModel.visible = true;
    setHead(thirdP);                               // hide head only in first person
    viewmodels[state.weapon].visible = !thirdP;    // weapon viewmodel only in first person
