...
(() => {
  ...
  function updateCharacter(dt) {
    ...
    // Measured (headfront/toe bones, bind + animated): model faces +Z locally.
    // Player forward at yaw=0 is -Z, so +PI points him where you move/aim —
    // back to the camera, standard third person.
